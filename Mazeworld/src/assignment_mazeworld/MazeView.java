...
//		Color colors[] = { Color.LIGHTGRAY, Color.WHITE };
	...
	public Node addMonoPiece(int c, int r) {
	...
	public Node removePiece(int c, int r) {

		int radius = (int)(pixelsPerSquare * .4);
		//Rectangle rec = new Rectangle(c*pixelsPerSquare, r*pixelsPerSquare, pixelsPerSquare *.98,pixelsPerSquare *.98);
		Circle piece = new Circle(squareCenterX(c), squareCenterY(r), radius);
